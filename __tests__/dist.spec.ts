...
import {collection, gattsu, guildUrl, mods, pikax, ships} from "./__config__/results";


import {swgoh, Swgoh} from "../dist";
import {getCharacters, getShips} from "../dist";


describe('test dist index.js file', () => {
